...
class HierBP:public BasicSSMAlgorithm
{
public:
...
HRESULT HierBP::OnD3D10CreateDevice(ID3D10Device *pDev10, const DXGI_SURFACE_DESC *pBackBufferSurfaceDesc, void *pUserContext)
{
    ...
    WCHAR str[MAX_PATH];
    V_RETURN(DXUTFindDXSDKMediaFileCch(str, MAX_PATH, (HIERBP_FILE_NAME) ));
    ID3D10Blob *pErrors;
...
void HierBP::OnD3D10FrameRender(CDXUTDialog &g_SampleUI,S3UTMesh &g_MeshScene,float g_fFilterSize,
