...
#include "DXUT.h"
#include "S3UTVertexShader.h"

S3UTVertexShader::S3UTVertexShader():S3UTShader()
{
    m_pVS = NULL;
    m_pInputLayout = NULL;
    m_VertexSize = 0;
...
S3UTVertexShader::~S3UTVertexShader()
{
}
