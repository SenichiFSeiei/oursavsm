...
// Begin ---------------------  Light Size -------------------------------------
#define LIGHT_SIZE0	0.1
#define LIGHT_SIZE1 0.1
#define LIGHT_SIZE2 0.1
#define LIGHT_SIZE3 0.1
...
// Begin ---------------------  Light Color ------------------------------------
#define LIGHT_COLOR0	D3DXVECTOR4(1,1,1,1)
#define LIGHT_COLOR1	D3DXVECTOR4(2,2,2,1)
#define LIGHT_COLOR2	D3DXVECTOR4(0.5,0.5,0.5,1)
#define LIGHT_COLOR3	D3DXVECTOR4(0.1,0.1,0.1,1)
#define LIGHT_COLOR4	D3DXVECTOR4(0.4,0.4,0.4,1)
#define LIGHT_COLOR5	D3DXVECTOR4(0.4,0.4,0.4,1)
#define LIGHT_COLOR6	D3DXVECTOR4(0.4,0.4,0.4,1)
