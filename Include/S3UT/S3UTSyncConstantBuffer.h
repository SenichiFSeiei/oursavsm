...
/*
    ...
    This is a templated class, so usage:    S3UTSynConstantBuffer<MyDataStruct> syncConstantBuffer;
*/
template<class DataStruct>
class S3UTSyncConstantBuffer : public DataStruct
{
public:

    S3UTSyncConstantBuffer()
    {
        m_pBuffer = NULL;
    }
